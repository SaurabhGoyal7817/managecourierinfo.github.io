...
<%
		...
		{
		if(client.getAdminID()==Integer.parseInt(adminId))
		{
		%>
		...
		<td><a class="btn btn-outline-light btn-lg bg-danger" href="DeleteData?deleteid=<%=client.getId()%>">Delete</a></td>
	    <td><a class="btn btn-outline-light btn-lg bg-success" href="updatedata.jsp?updateid=<%=client.getId()%>">Update</a></td>
		</tr>
